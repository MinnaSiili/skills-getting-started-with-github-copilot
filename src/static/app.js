document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      // Ignore stale responses when a newer refresh request already exists.
  ...
  activitiesList.addEventListener("click", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(result.detail || "Unable to unregister participant.", "error");
      }
    } catch (error) {
      setMessage("Failed to unregister participant. Please try again.", "error");
